	        ...
	        <nav class="navbar navbar-default navbar-sticky bootsnav">
	            ...
	            <div class="container">
	                ...
	                <div class="navbar-header">
	                    ...
	                    <a class="navbar-brand" href="index.html"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/logo.png" class="logo logo-scrolled" alt=""></a>
	                </div>
		...
		<section class="section-padding">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="block-img">
							<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/homepageblock.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img class="hvr-buzz-out" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/services/1.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/services/2.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/services/3.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/services/4.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/services/5.png" alt="" />
					...
					<div class="col-sm-6 col-md-4">
						<div class="services-tiem">
							<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/services/6.png" alt="" />
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-4">
							<div class="footer-widget about-us">
								<a href="index.html"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/logo-white.png" alt="" /></a>
								...
								<div class="online-card">
									<a href="#"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/online-card/1.png" alt="" /></a>
									<a href="#"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/online-card/2.png" alt="" /></a>
									<a href="#"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/online-card/3.png" alt="" /></a>
									<a href="#"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/online-card/4.png" alt="" /></a>
								</div>
							</div>
						...
						<div class="col-sm-6 col-md-3">
							<div class="footer-widget latest-post">
								...
								<ul>
									<li>
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/latest-post/1.png" alt="" />
										<p><a href="#">Headset No Longer Wire For Sound</a></p>
										<span>12 May 2016</span>
										
									</li>
									<li>
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/latest-post/2.png" alt="" />
										<p><a href="#">Headset No Longer Wire For Sound</a></p>
										<span>12 May 2016</span>
										
									</li>
									<li>
										<img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/latest-post/3.png" alt="" />
										<p><a href="#">Headset No Longer Wire For Sound</a></p>
										<span>12 May 2016</span>
